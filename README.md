...
This repo's [workflow](https://github.com/vile/ofac-sdn-list/actions/workflows/convert.yml) checks for changes to the SDN XML file every day at 6AM UTC.
A new release is created upon any change.
A new release does not guarantee new addresses have been added.
